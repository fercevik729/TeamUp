...
public class KeycloakJwtRolesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    /*
      Spring Bean responsible for converting roles from the JWT tokens produced by
      the Keycloak service. Use .hasAuthority() or .hasAnyAuthority() when using this converter
      in the web flux security filter chain.
     */
